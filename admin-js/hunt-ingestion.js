/**
 * ═════════════════════════════════════════════════════════════
 * LEX NOVA CRM v6.0 — MODULE 2: INGESTION GATE & HYDRATION
 * ═════════════════════════════════════════════════════════════
 * This module handles the UI for V5.0 JSON pasting, validates 
 * the payload, and executes the Hydration Merge against the CSV.
 */

// Establish namespace if not already defined
window.LexNova = window.LexNova || {};
LexNova.Ingestion = LexNova.Ingestion || {};

/**
 * ==========================================
 * THE STATIC DICTIONARIES
 * ==========================================
 * NOTE: For execution speed, the CSV data must be stored here as 
 * standard JavaScript objects. I have seeded the structure with 
 * the exact fields from your CSV uploads. 
 * Replace these seeds with your full converted JSON objects.
 */
...
LexNova.Ingestion.MIGRATION_MAP = {
    ...
    "UNI_CON_004": "UNI_CNS_004", 
    "UNI_CON_005": "UNI_CNS_005", 
    "UNI_CON_006": "UNI_CNS_006", 
    "UNI_HAL_001": "UNI_HAL_001", 
    "UNI_HAL_002": "UNI_HAL_002", 
    "UNI_HAL_003": "UNI_HAL_003", 
    "UNI_HAL_004": "UNI_HAL_004", 
    "UNI_LIA_001": "UNI_LIA_001", 
    "UNI_LIA_002": "UNI_LIA_002", 
    "UNI_LIA_003": "UNI_LIA_003", 
    "UNI_LIA_004": "UNI_LIA_004", 
    "UNI_LIA_005": "UNI_LIA_005", 
    "UNI_LIA_006": "UNI_LIA_006", 
    "UNI_SEC_001": "UNI_PRV_001", 
    "UNI_SEC_002": "UNI_PRV_002", 
    "UNI_SEC_003": "UNI_PRV_003", 
    "UNI_INF_001": "UNI_INF_001", 
    "UNI_INF_002": "UNI_INF_002", 
    "UNI_INF_003": "UNI_INF_003", 
    "UNI_WAS_001": "UNI_FRD_001", 
    "UNI_WAS_002": "UNI_FRD_002", 
    "UNI_EUR_001": "UNI_DEC_001", 
    "INT01_ROG_001": "DROPPED_REDUNDANT_WITH_UNI_HAL_001", 
    "INT01_ROG_002": "DROPPED_REDUNDANT_WITH_UNI_LIA_003", 
    "INT01_AGT_001": "UNI_LIA_007", 
    "INT01_AGT_002": "UNI_CNS_007", 
    "INT02_DIS_001": "I02_DEC_001", 
    "INT02_MED_001": "I02_HRM_001", 
    "INT02_CRA_001": "I02_DEC_002", 
    "INT02_MED_002": "I02_DEC_003", 
    "INT02_AUD_001": "I02_DEC_004", 
    "INT02_AUD_002": "I02_DEC_005", 
    "INT02_REG_001": "I02_DEC_006", 
    "INT02_REG_002": "I02_DEC_007", 
    "INT02_AUT_001": "I02_DEC_008", 
    "INT02_MED_003": "I02_HRM_002", 
    "INT02_EVD_001": "I02_FRD_001", 
    "INT02_EMP_001": "I02_DEC_009", 
    "INT02_EMP_002": "I02_DEC_010", 
    "INT03_COM_001": "I03_HRM_001", 
    "INT03_COM_002": "I03_HRM_002", 
    "INT03_COM_003": "I03_HRM_003", 
    "INT03_MIN_001": "I03_HRM_004", 
    "INT03_REG_001": "I03_HRM_005", 
    "INT03_REG_002": "I03_HRM_006", 
    "INT03_MIN_002": "I03_HRM_007", 
    "INT04_COP_001": "I04_INF_001", 
    "INT04_INF_001": "UNI_INF_004", 
    "INT04_SGI_001": "I04_INF_002", 
    "INT04_WTR_001": "I04_INF_003", 
    "INT04_COP_002": "I04_INF_004", 
    "INT04_PUB_001": "I04_INF_005", 
    "INT05_DIS_001": "I05_PRV_001", 
    "INT05_RAG_001": "I05_INF_001", 
    "INT05_DIS_002": "I05_PRV_002", 
    "INT05_DMC_001": "I05_INF_002", 
    "INT05_COP_001": "I05_INF_003", 
    "INT06_SUB_001": "I06_PRV_001", 
    "INT06_SUB_002": "I06_PRV_002", 
    "INT06_CPR_001": "I06_PRV_003", 
    "INT06_SLA_001": "I06_LIA_001", 
    "INT07_BIO_001": "I07_BIO_001", 
    "INT07_BIO_002": "I07_BIO_002", 
    "INT07_BIO_003": "I07_BIO_003", 
    "INT07_BIO_004": "I07_BIO_004", 
    "INT08_SEC_001": "I08_LIA_001", 
    "INT08_SEC_002": "I08_LIA_002", 
    "INT08_SEC_003": "I08_LIA_003", 
    "INT08_AUD_001": "I08_LIA_004", 
    "INT09_TRD_001": "I09_TRD_001", 
    "INT09_TRD_002": "I09_TRD_002", 
    "INT09_TRD_003": "I09_TRD_003", 
    "INT09_COL_001": "I09_TRD_004", 
    "INT10_PHY_001": "DROPPED_REDUNDANT_WITH_UNI_LIA_001", 
    "INT10_PHY_002": "I10_LIA_001", 
    "INT10_PHY_003": "DROPPED_REDUNDANT_WITH_UNI_LIA_005", 
    "INT10_PHY_004": "I10_LIA_002", 
    "INT10_PHY_005": "DROPPED_REDUNDANT_WITH_UNI_LIA_006" 
};

LexNova.Ingestion.REGISTRY = {
    "UNI_CNS_001": {
    ...
    "I07_BIO_004": {
        ...
        "FP_Impact": "multi-state compliance surface expansion as new laws activate. parallel BIPA-style statutory damages in each jurisdiction that passes one. and the compliance architecture that works for two states doesn't automatically scale to five",
        "FP_Stakes": "NULL",
...
/**
 * ==========================================
 * 1. THE 3-CARD INGESTION MODAL UI
 * ==========================================
 */
LexNova.Ingestion.openV5Modal = function(existingPid = null) {
    let p = {};
    let isUpdate = false;

    // If updating an existing prospect, load their data
    if (existingPid && LexNova.State && LexNova.State.allProspects) {
        p = LexNova.State.allProspects.find(x => x.id === existingPid) || {};
        isUpdate = true;
    }
    ...
    <div class="modal-grid">
        ...
        <div class="card" style="border-color: var(--gold-mid);">
            <div class="card-label" style="color: var(--gold);">1. V5.0 Skinny JSON Input</div>
            <div style="font-size: 9px; color: var(--marble-dim); margin-bottom: 10px;">Paste the raw JSON payload from Gemini below. The system will auto-hydrate the 20-field matrix.</div>
            <textarea id="v5-json-input" class="v5-json-area" placeholder="{ ...paste V5.0 Skinny JSON here... }" oninput="LexNova.Ingestion.validateV5JSON()"></textarea>
            <div id="v5-validation-msg" class="v5-validation-text" style="color: var(--marble-dim);">Awaiting payload...</div>
        </div>
        ...
        <div class="card">
            ...
            <div class="fg">
                ...
                <select id="v5-status" class="fi">
                    <option value="QUEUED" ${p.status === 'QUEUED' ? 'selected' : ''}>QUEUED (Unscheduled)</option>
                    <option value="SEQUENCE" ${p.status === 'SEQUENCE' ? 'selected' : ''}>IN SEQUENCE</option>
    ...
    const footerHtml = `
        ...
        <button class="btn btn-primary" id="v5-save-btn" onclick="LexNova.Ingestion.executeIngest('${existingPid || ''}')">Hydrate & Save to Firestore</button>
    `;
...
/**
 * ==========================================
 * 2. REAL-TIME JSON VALIDATOR
 * ==========================================
 */
LexNova.Ingestion.validateV5JSON = function() {
    const rawText = document.getElementById('v5-json-input').value.trim();
    const msgEl = document.getElementById('v5-validation-msg');
    const saveBtn = document.getElementById('v5-save-btn');

    if (!rawText) {
        msgEl.textContent = "Awaiting payload...";
        msgEl.style.color = "var(--marble-dim)";
        return;
    }
    ...
    try {
        ...
        msgEl.innerHTML = `✅ Valid V5.0 Payload Detected. Found ${gapCount} Gaps. Ready to Hydrate.`;
        msgEl.style.color = "var(--green)";
        saveBtn.disabled = false;

        // Auto-fill Logistics if present in JSON and fields are currently empty
        if (parsed.prospect_meta) {
...
LexNova.Ingestion.executeIngest = function(existingPid) {
    ...
    const batch = document.getElementById('v5-batch').value.trim().toUpperCase();
    
    if (!existingPid && batch.length !== 3) {
        if(typeof window.toast === 'function') window.toast("New prospects require a 3-character batch code (e.g., 04A).", "error");
        return;
    }
    ...
    if (LexNova.Ops && typeof LexNova.Ops.saveProspect === 'function') {
        ...
        console.error("[LexNova Ingestion] LexNova.Ops.saveProspect is not loaded yet.");
    }
};
