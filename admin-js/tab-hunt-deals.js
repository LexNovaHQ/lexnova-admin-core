    ...
    <div id="hunt-pipeline-view" class="hidden">
        ...
        <div class="tbl-wrap">
            <table>
                ...
                <tbody id="op-tbody"><tr><td colspan="9" class="loading">Loading...</td></tr></tbody>
            </table>
        </div>
...
// ════════════════════════════════════════════════════════════════════════
// ═════════ OUTREACH STATS PANEL ══════════════════════════════════════════
// ════════════════════════════════════════════════════════════════════════
function renderOutreachStats() {
    const today = todayStr();
    let totalSent=0, sentToday=0, repliedTotal=0, repliedToday=0;
    let inFUTotal=0, inFUToday=0, inNEGTotal=0, inNEGToday=0;
    let scanComp=0, converted=0, totalWithEmails=0;
